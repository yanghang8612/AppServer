                ...
                <div class="full-height-scroll">
                    <ul class="list-group elements-list">
                        <li class="list-group-item active">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getWithdrawRecords(-1)">
                                <small>全部记录</small>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getWithdrawRecords(0)">
                                <small>未处理记录</small>
                            </a>
                        </li>
                        <li class="list-group-item">
                        ...
                        <li class="list-group-item">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getWithdrawRecords(2)">
                                <small>异常记录</small>
                            </a>
                        </li>
...
<script>
    ...
    $(document).ready(function(){
        $('.tab-pane').load("/AppServer/withdraw_records.html?state=-1");
        $.ajax({
            type: "POST",
    ...
    function getWithdrawRecords(state) {
        $('.tab-pane').load("/AppServer/withdraw_records.html?state=" + state);
    }
</script>
