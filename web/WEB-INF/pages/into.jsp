                ...
                <div class="full-height-scroll">
                    <ul class="list-group elements-list">
                        <li class="list-group-item active">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getIntoRecords(-1)">
                                <small>全部用户</small>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getIntoRecords(0)">
                                <small>未处理用户</small>
                            </a>
                        </li>
                        <li class="list-group-item">
                        ...
                        <li class="list-group-item">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getIntoRecords(2)">
                                <small>异常用户</small>
                            </a>
                        </li>
...
<script>
    ...
    $(document).ready(function(){
        $('.tab-pane').load("/AppServer/into_records.html?state=-1");
        $.ajax({
            type: "POST",
    ...
    function getIntoRecords(state) {
        $('.tab-pane').load("/AppServer/into_records.html?state=" + state);
    }
</script>
