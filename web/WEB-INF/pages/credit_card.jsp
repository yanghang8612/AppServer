                ...
                <div class="full-height-scroll">
                    <ul class="list-group elements-list">
                        <li class="list-group-item active">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getApplyCreditCardRecords(0)">
                                <small>全部申请</small>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getApplyCreditCardRecords(7)">
                                <small>近七天申请</small>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getApplyCreditCardRecords(30)">
                                <small>近一个月申请</small>
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a data-toggle="tab" href="javascript:void(0)" onclick="getApplyCreditCardRecords(90)">
                                <small>近三个月申请</small>
                            </a>
                        </li>
...
<script>
    $(document).ready(function(){
        ...
        $('.tab-pane').load("/AppServer/credit_card_records.html?interval=0");
        $.ajax({
            type: "POST",
    ...
    function getApplyCreditCardRecords(interval) {
        $('.tab-pane').load("/AppServer/credit_card_records.html?interval=" + interval);
    }
</script>
